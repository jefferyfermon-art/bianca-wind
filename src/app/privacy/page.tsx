            ...
            <div className="flex flex-col gap-12">
              ...
              <section className="flex flex-col gap-4">
                ...
                <p className="text-[1.0625rem] leading-[1.75] text-ink/80">
                  ...
                  the page requested, and your browser&rsquo;s user-agent
                  string. That information is processed by Vercel as part of
              ...
              <section className="flex flex-col gap-4">
                ...
                <p className="text-[1.0625rem] leading-[1.75] text-ink/80">
                  ...
                  before the work begins. Nothing on this page grants access to
                  anything.
                </p>
              </section>
